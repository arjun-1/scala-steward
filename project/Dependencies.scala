...
object Dependencies {
  ...
  val circeGeneric = "io.circe" %% "circe-generic" % "0.13.0-RC1"
  ...
  val coursierCore = "eu.timepit" %% "coursier" % "2.0.0-RC5-6+24-95223638"
  val coursierCatsInterop = "eu.timepit" %% "coursier-cats-interop" % coursierCore.revision
  val disciplineScalatest = "org.typelevel" %% "discipline-scalatest" % "1.0.0-RC4"
  val fs2Core = "co.fs2" %% "fs2-core" % "2.2.1"
  val http4sAsyncHttpClient = "org.http4s" %% "http4s-async-http-client" % "0.21.0-RC1"
